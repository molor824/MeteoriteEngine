...
public class Input : ISingleton
{
    ...
    public static bool IsKeyDown(KeyList key)
    {
        unsafe
        {
...
public enum CursorMode
{
    ...
    /// </summary>
    Normal = 212993, // 0x00034001
    /// <summary>Hides the arrow cursor when over a window.</summary>
    Hidden = 212994, // 0x00034002
    /// <summary>
    ...
    /// </summary>
    Disabled = 212995, // 0x00034003
}
// Directly copied GLFW.Keys
// This way the user dont have to do `using OpenTK.Windowing.GraphicsLibraryFramework;` stuff
// Idk what' better way to allow users to access Keys enum by just doing `using Meteorite;`
public enum KeyList
{
